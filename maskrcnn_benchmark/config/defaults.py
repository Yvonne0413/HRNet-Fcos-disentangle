...
# ---------------------------------------------------------------------------- #
_C.MODEL.FCOS = CN()
_C.MODEL.FCOS.CLS_TOWER = CN()
_C.MODEL.FCOS.CLS_TOWER.GROUP_NORM_NUM = 32
_C.MODEL.FCOS.CLS_TOWER.APPLY = False
_C.MODEL.FCOS.BBOX_TOWER = CN()
...
_C.MODEL.FCOS.BBOX_TOWER.NUM_BRANCHES = 4
_C.MODEL.FCOS.BBOX_TOWER.OUT_CHANNELS_PERBRANCH = 1

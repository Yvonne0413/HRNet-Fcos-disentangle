...
def do_train(
    ...
    for iteration, (images, targets, _) in enumerate(data_loader, start_iter):
        ...
        for offset_idx in range(4):
            ...
            save_gradient_depu(gradients_as_arr, 'vis_temp_v1/vis_vbp_idx{}_offset{}'.format(iteration, offset_idx))

            gradient = cv2.imread('vis_temp_v1/vis_vbp_idx{}_offset{}_Vanilla_BP_gray.jpg'.format(iteration, offset_idx), cv2.IMREAD_GRAYSCALE)
        ...
        save_batch_maps(image_save, grad_map_save, None, 'vis_test/grad_map_{}.jpg'.format(iteration))
